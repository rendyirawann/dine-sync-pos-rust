...
- [ ] Stock (stok shared-mutable + konflik delta), Stock Opname — **DITUNDA atas permintaan user**.
...
- [~] **Fase 4** — Lebarkan modul (Kitchen ✅, Master Data ✅, Expense ✅, Laporan ✅, User/Role ✅, Queue ✅, Customer-QR ✅, Log Activity ✅ 2026-06-10; **hanya Stock yang sisa, ditunda**)
- [ ] **Fase 5** — Integrasi & polish
- [ ] **Fase 6** — Cutover
